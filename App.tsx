...
import { 
  collection, doc, addDoc, updateDoc, onSnapshot, query, orderBy, setDoc, deleteDoc
...
export default function App() {
  ...
  const seedDB = async () => {
    ...
    try {
      ...
      alert("Base de Datos en la Nube Inicializada Correctamente.");
    } catch (error) {
      console.error(error);
