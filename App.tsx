...
import { 
  collection, doc, addDoc, updateDoc, deleteDoc, onSnapshot, query, orderBy, setDoc // <--- AGREGADO deleteDoc
...
const ManagerView: React.FC<{ users: User[]; machines: Machine[]; records: MaintenanceRecord[] }> = ({ users, machines, records }) => {
  ...
  // FUNCION BORRAR USUARIO (NUEVA)
  const deleteUser = async (userId: string) => {
    if(!window.confirm("¿Seguro que desea eliminar a este empleado? Esta acción no se puede deshacer.")) return;
    try {
