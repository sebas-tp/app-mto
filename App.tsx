...
// --- HELPER SEGURO PARA FECHAS (EVITA CRASH) ---
...
// ... LeaderView y ManagerView se mantienen igual (copiar del bloque anterior, asegúrate de tener la versión con safeDate y validaciones de usuario si la modificaste allí también, pero el error reportado era en OperatorView).
// Para seguridad, te pego LeaderView y ManagerView con las protecciones aplicadas también.
            ...
            <Card className="w-full max-w-lg" onClick={(e: any) => e.stopPropagation()}>
                <div className="flex justify-between items-start mb-6">
                    <div>
                        ...
                        <p className="text-xs text-slate-400 font-bold uppercase">{format(parseISO(viewRecord.date), 'dd/MM/yyyy HH:mm')}</p>
                    </div>
