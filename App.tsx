...
// --- DEFINICIÓN DE TIPOS (INTEGRADA PARA EVITAR ERRORES DE VERCEL) ---
export enum Role {
  OPERATOR = 'OPERATOR',
  LEADER = 'LEADER',
  MANAGER = 'MANAGER',
